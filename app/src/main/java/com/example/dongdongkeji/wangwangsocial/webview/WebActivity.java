package com.example.dongdongkeji.wangwangsocial.webview;
...
import com.example.dongdongkeji.wangwangsocial.webview.webClient.MyWebClient;
...
public class WebActivity extends AppCompatActivity {
     ...
     * @param mWeb .
     */
    private void initWeb(WebView mWeb) {
        //获取setting
